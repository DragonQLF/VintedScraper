...
exports.addRandomMouseMovements = exports.randomDelay = exports.getRandomDelay = exports.getRandomUserAgent = void 0;
...
const getRandomUserAgent = () => {
    ...
    logger_1.logger.debug(`Selected user agent: ${randomAgent}`);
    return randomAgent;
};
 ...
 */
const getRandomDelay = (minMs = 500, maxMs = 1500) => {
 ...
 */
const randomDelay = async (minMs = 500, maxMs = 1500) => {
    const delay = (0, exports.getRandomDelay)(minMs, maxMs);
    logger_1.logger.debug(`Waiting for ${delay}ms`);
 ...
 */
const addRandomMouseMovements = async (page) => {
    ...
    for (let i = 0; i < movements; i++) {
        ...
        await (0, exports.randomDelay)(50, 150); // Reduced delay between movements
    }
};
exports.addRandomMouseMovements = addRandomMouseMovements;
// Export all functions
exports.default = {
    getRandomUserAgent: exports.getRandomUserAgent,
    getRandomDelay: exports.getRandomDelay,
    randomDelay: exports.randomDelay,
    addRandomMouseMovements: exports.addRandomMouseMovements
};
